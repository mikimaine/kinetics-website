                    ...
                    <div className="flex items-center mb-8">
                        <Link href="#" legacyBehavior>
                            <a className="mr-auto text-3xl font-semibold leading-none">
                                <img className="h-6" src="/assets/imgs/logos/kbi_white_bg.png" alt="Kinetics Business Intelligence Logo" />
                            </a>
                        </Link>
                        ...
                        <ul className="mobile-menu">
                            ...
                            <li className="mb-1">
                                <Link href="/products" legacyBehavior>
                                    <a className="block p-4 text-sm text-blueGray-500 hover:bg-blue-50 hover:text-blue-500">Products</a>
                                </Link>
                            </li>
                            {/* <li className="mb-1">
