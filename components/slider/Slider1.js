    ...
    return (
        <>
                    ...
                    <div className="px-3 pb-5">
                        <div className="card-slider group">
                            ...
                            <div className="flex justify-between items-end">
                                ...
                                <div>
                                    <Link href="/services" legacyBehavior>
                                        <a className="tracking-wide hover-up-2 mr-2 inline-block px-4 py-3 text-xs text-brightRed font-semibold leading-none border border-blue-200 hover:border-brightRed hover:text-white hover:bg-brightRed rounded">View Details</a>
                                    </Link>
                                </div>
                            </div>
                        </div>
            ...
            <div id="carausel-2-columns-1-arrows" className="flex">
                <span className="mr-4 text-brightRed flex slick-arrow custom_prev">
                    <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M7 16l-4-4m0 0l4-4m-4 4h18"></path>
                    </svg>
                </span>
                <span className="text-brightRed flex slick-arrow custom_next">
                    <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
